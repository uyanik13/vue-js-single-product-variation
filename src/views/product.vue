            ...
            <div class="vx-row lg:mt-6 ">
              <div class="vx-col flex-none sm:flex-1 lg:flex xl:flex-1 md:flex-auto justify-end ">
                ...
                <div class="w-4/12 sm:w-4/12 md:w-full lg:w-5/12 xl:w-5/12 lg:mt-2 lg:mr-24">
                  <img :src="project_base_url+'images/sofa-'+opt_color.substr(1)+'.png'" :alt="item_data.name" class="responsive ">
                </div>
                ...
                ">
                  <img :src="project_base_url+addition_image_1" v-if="addition_image_1" :alt="item_data.name" class="responsive">
                </div>
                ...
                ">
                 <img :src="project_base_url+addition_image_2" v-if="addition_image_2" :alt="item_data.name" class="responsive">
                </div>
                  ...
                  <div class="vx-col w-full">
                    ...
                    <div class="flex flex-wrap items-center mt-2">
                      <div
                        ...
                        <img :src="project_base_url+'images/'+data.image+'.png'"  :alt="item_data.name" class="w-12">
                        </vx-tooltip>
                        </div>
                    </div>
                  </div>
...
export default{
  ...
  data () {
    return {
     ...
     project_base_url: 'https://demo.dijitalreklam.org/vue-product/',
     addition_image_1: '',
     addition_image_2: '',
      error_occured: false,
      error_msg: '',
      ...
      available_addition_item_1_images: [{'image':'w-image-0','desc':'None','price':'0'},{'image':'w-image-1','desc':'White - +50 USD','price':'50'},{'image':'w-image-2','desc':'+50 USD','price':'50'},{'image':'w-image-3','desc':'+50 USD','price':'50'},{'image':'w-image-4','desc':'+50 USD','price':'50'},{'image':'w-image-5','desc':'+50 USD','price':'50'}],
      available_addition_item_2_images: [{'image':'h-image-0','desc':'None','price':'0'},{'image':'h-image-1','desc':'Black - +50 USD'},{'image':'h-image-2','desc':'+50 USD','price':'50'},{'image':'h-image-3','desc':'+50 USD','price':'50'},{'image':'h-image-4','desc':'+50 USD','price':'50'},{'image':'h-image-5','desc':'+50 USD','price':'50'}],
      opt_color: '#7367F0',
      clickedRef: "",
      priceIncreased: true,
      priceDecreased: true,
  ...
  methods: {
    ...
    clickedAddition(image,thisImage,type){
            ...
            this[thisImage]=this.project_base_url+`images/${image}.png`
    },
